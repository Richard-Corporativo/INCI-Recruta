  ...
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-lg">
      <div className="flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar text-slate-900 dark:text-white">
          <form id="schedule-form" className="space-y-5" onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2 sm:col-span-1">
                ...
                <select
                  className="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white sm:text-sm focus:ring-primary focus:border-primary"
                  value={formData.type}
              ...
              <div className="col-span-2 sm:col-span-1">
                ...
                <select
                  className="w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white sm:text-sm focus:ring-primary focus:border-primary"
            ...
            <div>
              ...
              <input
                className="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 py-2 px-3 text-slate-900 dark:text-white sm:text-sm focus:ring-primary focus:border-primary"
            ...
            <div>
              ...
              <textarea
                className="block w-full rounded-lg border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 py-2 px-3 text-slate-900 dark:text-white sm:text-sm focus:ring-primary focus:border-primary placeholder-slate-400"
