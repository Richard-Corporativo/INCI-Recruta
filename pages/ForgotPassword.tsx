        ...
        <div className="font-display bg-background text-foreground transition-colors duration-200 antialiased overflow-x-hidden min-h-screen flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-2xl font-semibold text-foreground tracking-tight text-center">Recrutamento Interno</h1>
                ...
                <div className="bg-card border border-border shadow-xl rounded-lg overflow-hidden">
                    <div className="p-8">
                        ...
                        <form className="flex flex-col gap-5">
                            ...
                            <button className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-base shadow-sm text-sm font-semibold text-primary-foreground bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 transition-all duration-200 ease-in-out active:translate-y-[1px]" type="button">
                                Enviar link de redefinição
                            </button>
                        </form>
                        <div className="mt-6 flex items-center justify-center">
                            <Link to="/login" className="text-sm font-semibold text-muted-foreground hover:text-foreground flex items-center gap-1 transition-all duration-200 ease-in-out">
