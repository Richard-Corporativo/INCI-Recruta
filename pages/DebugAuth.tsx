...
const DebugAuth: React.FC = () => {
    ...
    return (
        <div className="p-8 space-y-8 bg-slate-50 min-h-screen font-mono text-sm max-w-4xl mx-auto">
            <h1 className="text-2xl font-bold mb-4 border-b pb-2">Diagnóstico de Autenticação</h1>

            <section className="space-y-2">
                <h2 className="text-lg font-bold text-blue-600">1. Estado do Contexto (AuthContext)</h2>
                <div className="bg-white p-4 border rounded shadow-sm overflow-auto max-h-60">
                    <pre>{JSON.stringify({ isAuthenticated, isLoading: authLoading, user }, null, 2)}</pre>
                </div>
            </section>

            <section className="space-y-2">
                <h2 className="text-lg font-bold text-green-600">2. Sessão Supabase (Raw)</h2>
                <div className="bg-white p-4 border rounded shadow-sm overflow-auto max-h-60">
                    {session ? (
                        <>
            ...
            <section className="space-y-2">
                <h2 className="text-lg font-bold text-purple-600">3. Teste de Banco de Dados (Tabela 'users')</h2>
            ...
            <section className="space-y-2">
                <h2 className="text-lg font-bold text-orange-600">4. Teste de RLS (Permissões)</h2>
                <div className="bg-white p-4 border rounded shadow-sm overflow-auto">
