// @component ProfileSkeleton | @tipo componente | @versao 1.0.0
// > Skeleton para perfil do candidato
...
const ProfileSkeleton = () => {
    return (
        <div className="max-w-6xl mx-auto w-full px-4 md:px-10 lg:px-14 py-8 md:py-12 flex flex-col gap-10">
            ...
            {/* Form Skeleton */}
            <div className="bg-card rounded-2xl overflow-hidden p-6 border border-border">
                {/* Avatar Section */}
                <div className="p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 border-b border-border">
                    <Skeleton type="rect" width={128} height={128} className="rounded-xl shrink-0" />
                ...
                <div className="p-8 md:p-12 space-y-8">
                    <Skeleton type="title" width={200} height={24} />
                    <Skeleton type="rect" width="100%" height={150} className="rounded-lg" />
                </div>
            </div>
        </div>
    );
