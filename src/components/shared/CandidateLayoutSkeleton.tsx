// @component CandidateLayoutSkeleton | @tipo componente | @versao 1.0.0
// > Skeleton de carregamento para layout candidato
    ...
    return (
        <div className="flex min-h-screen w-full bg-background transition-colors">
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden">
                ...
                <div className="md:hidden flex items-center justify-between p-6 -b - bg-card">
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-10 lg:p-14">
                    <div className="max-w-6xl mx-auto flex flex-col gap-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="h-48 rounded-xl bg-card p-6 flex flex-col justify-between">
