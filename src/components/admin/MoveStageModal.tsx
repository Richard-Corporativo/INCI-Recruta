// @component MoveStageModal | @tipo componente | @versao 1.0.0
// > Modal para mover candidato entre etapas do pipeline
// @api candidateId: string, currentStage: KanbanColumnId, isOpen: bool, onClose: fn
      ...
      <div className="p-6 bg-card transition-colors relative">
        ...
        <div className="space-y-5">
          <div>
            ...
            <div className="mt-2 flex items-start gap-1.5 transition-colors">
              <Icon icon="material-symbols:lock-open" className="text-primary mt-0.5 h-5 w-5" aria-hidden="true" />
        ...
        <div className="mt-8 flex items-center justify-end gap-3 pt-6 border-t border-border transition-colors">
          ...
          >
            ...
            <Icon icon="material-symbols:arrow-forward" className="h-4 w-4" aria-hidden="true" />
          </button>
        </div>
      </div>
    </BaseModal>
