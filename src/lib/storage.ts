// @component Storage (DEPRECATED) | @tipo lib | @versao 1.0.0
// > Abstração localStorage — migrar para Supabase Services

import { Job, Candidate, Role, AuditLog, User } from '@src/types';
...
export const StorageService = {
    ...
    initialize() {
        ...
        const defaultAdmin: User = {
            ...
            role: 'admin',
            status: 'active',
            lastAccess: formatDate(new Date()),
            password: 'admin'
        };
